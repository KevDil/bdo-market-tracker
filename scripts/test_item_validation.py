...
def test_valid_item():
    ...
    # Simuliere OCR-Text mit validem Item (Lion Blood ist in item_names.csv)
    text = (
...
def test_ocr_error_correction():
    ...
    # Simuliere OCR-Fehler: 'F Lion Blood' statt 'Lion Blood'
    # (wie im echten Fall: "Placed order f Lion Blood")
    text = (
        "Central Market Buy 2025.10.12 10.00 "
    ...
    if results:
        ...
        return True  # Verwerfen ist OK, besser als falschen Namen speichern
...
def test_invalid_item():
    ...
    # Simuliere komplett falschen Item-Namen (nicht in Whitelist)
    text = (
        "Central Market Buy 2025.10.12 10.00 "
...
def test_ui_garbage():
    ...
    # Simuliere UI-Text als falschen Item-Namen
    text = (
        "Central Market Buy 2025.10.12 10.00 "
