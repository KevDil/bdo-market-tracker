...
- Detail-/Metrics-ROI wird sofort neu ausgelesen, sobald im Log-ROI keine Transaktionsanker (`transaction of`, `placed order`, `withdrew order`, `sales/orders completed`) mehr auftauchen. Damit aktualisiert sich der Fensterstatus nach einem Wechsel ins Item-Dialogfenster innerhalb des ersten Scans.
